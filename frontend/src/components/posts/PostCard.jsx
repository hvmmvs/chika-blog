        ...
        <div className="p-6">
          {post.category && (
            <Link
              ...
              className="relative z-10 inline-block text-xs font-semibold uppercase tracking-wider text-accent-700 bg-accent-50 px-3 py-1 rounded-full hover:bg-accent-100 transition-colors"
            >
              {post.category.name}
            </Link>
          )}
          <h2 className="text-xl font-bold tracking-tight leading-snug mt-3 text-ink group-hover:text-accent-500 transition-colors">
            {title}
          </h2>
          {excerpt && (
